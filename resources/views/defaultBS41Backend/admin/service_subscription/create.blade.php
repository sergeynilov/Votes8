...
@section('content')
    ...
    <!-- Page Content : service subscriptions create -->
    <div id="page-wrapper" class="card">

        <section class="card-body">
            <h4 class="card-title">{!! $viewFuncs->showAppIcon('service','transparent_on_white') !!}Create service subscription</h4>

            <form method="POST" action="{{ url('/admin/service-subscriptions') }}" accept-charset="UTF-8" id="form_service_subscription_edit" enctype="multipart/form-data">
                {!! csrf_field() !!}
    ...
    <!-- /.page-wrapper Page Content : service subscriptions create End -->
