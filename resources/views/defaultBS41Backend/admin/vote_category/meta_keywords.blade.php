...
@if(!empty($metaKeywords) and count($metaKeywords) == 0)
    ...
    <div class="form-row p-2">
        ...
        <div class="col-3">
            <button type="button" onclick="javascript:backendVoteCategory.attachMetaKeywordToVote()" class="btn btn-primary">
                &nbsp;Add
            </button>&nbsp;&nbsp;
        </div>
    </div>
@else
        ...
        <table class="table table-bordered table-striped text-primary ">
            @foreach($metaKeywords as $next_meta_keyword)
                <tr>
                    ...
                    <td style="width: 5%">
                        <a href="#" onclick="javascript:backendVoteCategory.clearMetaKeywordToVoteCategory('{{$next_meta_keyword}}')">
    ...
    <div class="form-row p-2">
        ...
        <div class="col-3">
            <button type="button" onclick="javascript:backendVoteCategory.attachMetaKeywordToVoteCategory()" class="btn btn-primary">
                &nbsp;Add
            </button>&nbsp;&nbsp;
        </div>
    </div>
...
<div class="form-row p-2 pt-5">
    ...
    <div class="col-9">
        {!! $viewFuncs->text( 'vote_category_meta_description', $voteCategory->meta_description, "form-control editable_field", [ "maxlength"=>"255" ] ) !!}
    </div>
</div>
