...
@section('content')
    ...
    <!-- Page Content : tag edit -->
    <div id="page-wrapper" class="card">

        <section class="card-body">
            <h4 class="card-title">{!! $viewFuncs->showAppIcon('tag','transparent_on_white') !!}Edit tag</h4>

            <form method="POST" action="{{ url('/admin/tags/'.$tag->id) }}" accept-charset="UTF-8" id="form_tag_edit" enctype="multipart/form-data">
                @method('PUT')
                {!! csrf_field() !!}
