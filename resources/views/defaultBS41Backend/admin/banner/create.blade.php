...
@section('content')
    ...
    <!-- Page Content : banner create -->
    <div id="page-wrapper" class="card">

        <section class="card-body">
            <h4 class="card-title">{!! $viewFuncs->showAppIcon('banner','transparent_on_white') !!}Create banner</h4>

            <form method="POST" action="{{ url('/admin/banners') }}" accept-charset="UTF-8" id="form_banner_edit" enctype="multipart/form-data">
                {!! csrf_field() !!}
    ...
    <!-- /.page-wrapper  Page Content : banner create  -->
