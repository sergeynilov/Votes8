...
@section('content')
    ...
    <div id="page-wrapper" class="card">
        ...
        <section class="card-body">
            <h4 class="card-title">{!! $viewFuncs->showAppIcon('event','transparent_on_white') !!}Edit event</h4>

            <form method="POST" action="{{ url('/admin/events/'.$event->id) }}" accept-charset="UTF-8" id="form_event_edit"
    ...
    <!-- /.page-wrapper Page Content : events edit End -->
