...
@section('content')
	...
	<!-- Page Content : external_news_importing edit -->
	<div id="page-wrapper" class="card">

		<section class="card-body">
			<h4 class="card-title">{!! $viewFuncs->showAppIcon('external-link','transparent_on_white') !!}Edit external news importing</h4>

			<form method="POST" action="{{ url('/admin/external-news-importing/'.$externalNewsImporting->id) }}" accept-charset="UTF-8"
			      id="form_external_news_importing_edit"
	...
	<!-- /.page-wrapper Page Content : external_news_importing edit End -->
