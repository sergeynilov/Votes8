...
@section('content')
    ...
    <!-- Page Content : site_subscriptions edit -->
    <div id="page-wrapper" class="card">

        <section class="card-body">
            <h4 class="card-title">{!! $viewFuncs->showAppIcon('subscription','transparent_on_white') !!}Edit site subscription</h4>

            <form method="POST" action="{{ url('/admin/site-subscriptions/'.$siteSubscription->id) }}" accept-charset="UTF-8" id="form_site_subscription_edit"
    ...
    <!-- /.page-wrapper Page Content : site_subscriptions edit End -->
